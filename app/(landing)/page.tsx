...
export default function TurfBuddieLanding() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      {/* Hero Section */}
      <section className="bg-white dark:from-gray-900 dark:to-gray-950 py-12 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <div className="order-1 md:order-1 min-w-0">
              ...
              <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-xl">
                {`${headerCity}'s`} smartest turf booking platform. Real-time slot availability, split payments with your squad, find new players, and compete in local tournaments.
              </p>
            ...
            <div className="relative order-2 md:order-2 min-w-0">
              ...
              {/* Field mockup */}
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-green-600 via-green-500 to-emerald-500 aspect-[4/3] shadow-2xl">
                {/* Field grid pattern */}
                <div
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 sm:w-56 sm:h-56 rounded-full border-2 border-white/40" />
                ...
                {/* Goal box (bottom) */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/3 h-16 sm:h-20 border-2 border-t-0 border-white/40" />
                {/* Goal (bottom) */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-16 sm:w-20 h-3 sm:h-4 bg-white/50" />

                {/* Goal box (top) */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-16 sm:h-20 border-2 border-b-0 border-white/40" />
              </div>
