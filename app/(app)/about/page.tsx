...
export const metadata: Metadata = {
  title: "About TurfBuddies | Smart Turf & Tournament Management Platform",
  description:
    "Learn about TurfBuddie's mission, vision, and values. Discover how we're transforming turf booking in Nagpur and Vidarbha with innovation and community focus.",
};
